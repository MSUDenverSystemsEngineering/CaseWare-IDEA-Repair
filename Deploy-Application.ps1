...
Try {
	...
	[string]$appVendor = 'CaseWare'
	[string]$appName = 'IDEA'
	[string]$appVersion = 'Repair'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '02/22/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'idea' -CheckDiskSpace -PersistPrompt
		...
		[scriptblock]$HKCURegistrySettings = {
			Remove-RegistryKey -Key 'HKCU\Software\CaseWare IDEA' -Recurse -SID $UserProfile.SID
			Set-RegistryKey -Key 'HKCU\Software\CaseWare IDEA\CaseWare IDEA\Config' -Name 'NextUpgradeCheck' -Value '0' -SID $UserProfile.SID
			Set-RegistryKey -Key 'HKCU\Software\CaseWare IDEA\CaseWare IDEA\Config' -Name 'DisplayIntroPage' -Value '0' -Type 'DWord' -SID $UserProfile.SID
		}

		Get-ChildItem -Path "${envSystemDrive}\Users" -Force | ?{ $_.PSIsContainer } | ForEach-Object {
			$IDEAFolder = $_.FullName + "\Documents\My IDEA Documents"
			If ((Test-Path $IDEAFolder) -eq $true) {
				Remove-Folder $IDEAFolder
			}
		}
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'idea' -CloseAppsCountdown 60
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA1IV3GEIQFnRsC
# jPczNtHyQ6nf7xsE7VHPVY5biCve/KCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIINZ
# MrQTgM7pcJnQ3FM9foGSL4zDOPWBpxmc+ZP5zQIQMA0GCSqGSIb3DQEBAQUABIIB
# AK41PnncglB2y2MigZkRRY5TJq4Yo9hjwRSNuLFPKwtw0RMKnXapiw8WmiBLzpnl
# xr9i2liT+cfKVHss15GW65v6Fb47tU4BUgAyd+z9xxaJhOasZRtwco8BU9teLGOR
# eRkkuRmzSSPgxBdLcCoEXUTwZ6os6dz2IGA8ETGgkWUlYG/0JxH3bIhUrYpG2MNj
# DdhCTrbbluchtEMgnGGkhgmUEWPClaxJ4K4Mo8ck8dOYSUD8NQ9xv2jvqPrVybHv
# mbk9SL5Lufb+o8RoqwQCTRGCmyrdr/1e/ml5EeYiit3dIIubD30YqR1hKcfiWi5e
# gA6i53OHKuBNJ8zln05KFcGhggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTcwMjIzMDAwNTM3WjAjBgkqhkiG9w0BCQQxFgQU
# MV8DI028kjrbQ+h9f1wZe1R9e4EwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBAJ3ByGk9z4YpyhWco4sZWi1jgXXYlLjRT7FJz57ceGlw5jrmInyskR9m
# 0OhTz8NlKrGn4Bd9oAVcBII3dvCsacOrNPXyKb9FA7LuXlYP/MjgQTqtdUWjuEwX
# 7dBL/qTPPPaeh7cRdtNRZWcSmtT8grRLlWP0cnQzHTI/ro6jbYzcsN8zx/rwjR5L
# SP6687+VQPCTWcZvsoMuI6Xq6xG79pdDTLM+L8Kk+gZvjHZh5GfSixvf2QzvyKtk
# 28PAA0QG41OTn/xn7TezYUC+V/nDpSGiQgurRTRkeKywA/v4F1gcJ8XOhxZjCbkQ
# VUkxYvk/jLcQgNEVO8V4CBV7OsFZVoU=
